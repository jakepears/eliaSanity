...
// node_modules/sanity-plugin-asset-source-unsplash/lib/index.js
var import_jsx_runtime2 = __toESM(require_jsx_runtime());

// node_modules/sanity-plugin-asset-source-unsplash/node_modules/@sanity/icons/dist/index.js
    ...
    InfiniteScroll2.prototype.render = function() {
      ...
      return import_react2.default.createElement(
        ...
        import_react2.default.createElement(
          ...
          this.props.pullDownToRefresh && import_react2.default.createElement(
            "div",
...
function PhotoRenderer(props) {
  ...
  return React2.createElement(React2.Fragment, null, (_b = renderPhoto == null ? void 0 : renderPhoto({
    photo,
    layout,
    layoutOptions,
    imageProps,
...
function defaultRenderRowContainer({
  ...
  return React2.createElement("div", { ...rowContainerProps }, children);
}
function RowContainerRenderer(props) {
  ...
  return React2.createElement(React2.Fragment, null, (renderRowContainer != null ? renderRowContainer : defaultRenderRowContainer)({
    layoutOptions,
    rowIndex,
    rowsCount,
    rowContainerProps,
...
function RowsLayout(props) {
  ...
  if (!rowsLayout)
    return null;
  return React2.createElement(React2.Fragment, null, rowsLayout.map((row, rowIndex) => React2.createElement(
    ...
    row.map(({ photo, layout }) => React2.createElement(
      PhotoRenderer,
      {
...
function defaultRenderColumnContainer({
  ...
  return React2.createElement("div", { ...columnContainerProps }, children);
}
...
function ColumnContainerRenderer(props) {
  ...
  return React2.createElement(React2.Fragment, null, (renderColumnContainer != null ? renderColumnContainer : defaultRenderColumnContainer)({
    layoutOptions,
    columnContainerProps,
    children,
    ...rest
...
function ColumnsLayout(props) {
  ...
  return React2.createElement(React2.Fragment, null, columnsModel.map((column, columnIndex) => React2.createElement(
    ...
    column.map(({ photo, layout }) => React2.createElement(
      PhotoRenderer,
      {
        key: photo.key || photo.src,
        photo,
...
function MasonryLayout(props) {
  ...
  if (!masonryLayout)
    return null;
  return React2.createElement(React2.Fragment, null, masonryLayout.map((column, columnIndex) => React2.createElement(
    ColumnContainerRenderer,
    {
...
function defaultRenderContainer({ containerProps, children, containerRef }) {
  return React2.createElement("div", { ref: containerRef, ...containerProps }, children);
}
function ContainerRenderer(props) {
  ...
  return React2.createElement(React2.Fragment, null, (renderContainer != null ? renderContainer : defaultRenderContainer)({
    containerProps,
    containerRef,
    layout,
    children
...
function useContainerWidth(breakpoints2, defaultContainerWidth) {
  const [{ containerWidth }, dispatch] = React2.useReducer(containerWidthReducer, {
    containerWidth: defaultContainerWidth
  });
  const ref = React2.useRef(null);
  const observerRef = React2.useRef();
  const containerRef = React2.useCallback(
    (node) => {
      var _a;
...
function UnsplashIcon() {
  return (0, import_jsx_runtime2.jsxs)("svg", { role: "img", viewBox: "0 0 25 25", width: "1em", height: "1em", fill: "currentColor", children: [
    (0, import_jsx_runtime2.jsx)("title", {}),
    (0, import_jsx_runtime2.jsx)("path", { d: "M9 9V4h7v5H9Zm7 3h5v9H4v-9h5v5h7v-5Z" })
  ] });
}
var fetchSearch = (client, query, page, perPage) => defer(
...
var fetchList = (client, type, page, perPage) => defer(
  () => client.observable.request({
...
var search = (client, query, page, resultsPerPage) => concat(
  query.pipe(
    withLatestFrom(page),
    debounceTime(500),
    distinctUntilChanged(),
...
`;
var CreditLineLink = pt.a`
  text-decoration: none;
  cursor: pointer;
`;
var CreditLine = pt(Card)`
  ${({ theme }) => `
...
function Photo(props) {
  const { onClick, data, onKeyDown, onFocus, active, width, height } = props, handleClick = (0, import_react3.useCallback)(() => {
    onClick(data);
  }, [onClick, data]), handleCreditLineClicked = (0, import_react3.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event) => {
    ...
    [data]
  ), handleKeyDown = (0, import_react3.useCallback)(
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    (event) => {
      onKeyDown(event), event.keyCode === 13 && onClick(data);
    },
    [onKeyDown, data, onClick]
  ), handleMouseDown = (0, import_react3.useCallback)(() => {
    onFocus(data);
  }, [onFocus, data]);
  ...
  return (0, import_jsx_runtime2.jsx)(
    Root,
    {
      ...
      onClick: handleClick,
      children: (0, import_jsx_runtime2.jsx)(CreditLineLink, { onClick: handleCreditLineClicked, children: (0, import_jsx_runtime2.jsx)(CreditLine, { padding: 2, radius: 2, margin: 2, children: (0, import_jsx_runtime2.jsxs)(Text, { size: 1, title: `Open image by ${userName} on Unsplash in new window`, children: [
        "By @",
        data.user.username
      ] }) }) })
    }
...
function UnsplashAssetSource(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(UnsplashAssetSourceInternal, { ...props, client });
}
var UnsplashAssetSourceInternal = class extends import_react3.default.Component {
  constructor() {
    super(...arguments), __publicField(this, "state", {
      ...
      searchResults: [[]],
      isLoading: true
    }), __publicField(this, "searchSubscription", null), __publicField(this, "searchSubject$", new BehaviorSubject("")), __publicField(this, "pageSubject$", new BehaviorSubject(1)), __publicField(this, "handleSelect", (photo) => (this.setState({ isLoading: true }), fetchDownloadUrl(this.props.client, photo).then((downloadUrl) => {
      ...
      this.setState({ query, page: 1, searchResults: [[]], isLoading: true, cursor: 0 }), this.pageSubject$.next(1), this.searchSubject$.next(query);
    }), __publicField(this, "handleSearchTermCleared", () => {
      this.setState({ query: "", page: 1, searchResults: [[]], isLoading: true, cursor: 0 }), this.pageSubject$.next(1), this.searchSubject$.next("");
    }), __publicField(this, "handleScollerLoadMore", () => {
      const nextPage = this.state.page + 1;
      this.setState({ page: nextPage, isLoading: true }), this.pageSubject$.next(nextPage), this.searchSubject$.next(this.state.query);
      ...
      const { photo, layout } = props, active = this.getPhotos().findIndex((result) => result.id === photo.data.id) === this.state.cursor || false;
      return (0, import_jsx_runtime2.jsx)(
        Photo,
        {
  ...
  render() {
    ...
    return (0, import_jsx_runtime2.jsx)(
      Dialog,
      {
        ...
        open: true,
        width: 4,
        children: (0, import_jsx_runtime2.jsxs)(Stack, { space: 3, paddingX: 4, paddingBottom: 4, children: [
          ...
          !isLoading && this.getPhotos().length === 0 && (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: "No results found" }),
          (0, import_jsx_runtime2.jsx)(
            index_es_default,
            {
              ...
              height: "60vh",
              loader: (0, import_jsx_runtime2.jsx)(Flex, { align: "center", justify: "center", padding: 3, children: (0, import_jsx_runtime2.jsx)(Spinner, { muted: true }) }),
              endMessage: (0, import_jsx_runtime2.jsx)(Text, { size: 1, muted: true, children: "No more results" }),
              children: searchResults.filter((photos) => photos.length > 0).map((photos, index) => (0, import_jsx_runtime2.jsx)(
                PhotoAlbum,
                {
                  layout: "rows",
...
var unsplashImageAsset = definePlugin({
...
react-infinite-scroll-component/dist/index.es.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=sanity-plugin-asset-source-unsplash.js.map
